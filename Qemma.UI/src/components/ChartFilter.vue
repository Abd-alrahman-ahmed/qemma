    ...
    <div class="collapse filter" :id="filterId">
      <div class="form-row">
        <div class="form-group col-lg-3 col">
          <label class="control-label">{{$locales.t('app.filter.from')}}</label>
          <input :dir="$locales.direction()" :placeholder="$locales.t('app.filter.from')" onfocus="this.select();" 
            class="form-control bg-transparent" required v-model="from" type="date" />
        </div>
        <div class="form-group col-lg-3 col ">
          <label class="control-label">{{$locales.t('app.filter.to')}}</label>
          <input :dir="$locales.direction()" :placeholder="$locales.t('app.filter.to')" onfocus="this.select();" 
        ...
        <div class="form-group col-lg-4 col">
          ...
          <v-select :dir="$locales.direction()" :clearable="false" 
            ...
            label="name" v-model="operation" :placeholder="$locales.t('app.filter.operator')" required>
            <template #no-options>
